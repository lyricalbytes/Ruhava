  ...
  return (
    <header className=" hidden md:block">
      ...
      <div className="flex items-center justify-between py-5 px-4 lg:px-12 xl:px-24">
        ...
        <h1 className="text-center font-larken font-medium text-[34px] tracking-wider flex-5">
          RUHAVA
        </h1>
        ...
        <div className="flex">
          {navItems.map((item) => (
            <a
              key={item}
              href="#"
              className={`whitespace-nowrap text-xs md:text-sm px-1 lg:px-15 lg:text-[13px] font-semibold tracking-wide ${
